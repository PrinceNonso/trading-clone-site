      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-6 text-gray-400 text-sm md:text-base leading-relaxed">
            ...
            returns while mitigating risks associated with the volatility of the
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div
              key={index}
              className="bg-[#11161d] border border-white/5 rounded-xl p-8 transition-all duration-300 hover:border-[#c8e632]/30 hover:shadow-[0_0_30px_rgba(200,230,50,0.05)] flex flex-col">
